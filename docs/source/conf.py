...
Copyright
    ...
    pobackup is distributed in the hope that it will be useful, but
...
htmlhelp_basename: str = 'pobackupdoc'
latex_elements: Dict[Any, Any] = {}
latex_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'pobackup.tex', 'pobackup Documentation',
    'Vladimir Roncevic \\textless{}elektron.ronca@gmail.com\\textgreater{}',
    'manual'
)]
man_pages: List[Tuple[Any, ...]] = [(
    master_doc, 'pobackup', 'pobackup Documentation', [author], 1
)]
texinfo_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'pobackup', 'pobackup Documentation', author, 'pobackup',
